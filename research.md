...
main memory hierarchies featuring emerging non-volatile memory technologies for newer Android and app versions. In this project, we developed META, a
...
- [**Framework for Analyzing Benchmarks**](/proj_pages/fab.md)<br>
**Advisor**: [_Prof. Manu Awasthi_](https://www.cs.utah.edu/~manua/)<br>
...
Architecting autonomous driving systems has garnered significant attention from industry with Google, Tesla, Uber, Waymo making huge investments for the same.  Building autonomous driving systems is challenging due to strict performance requirements of making functionally correct decisions always, by processing incoming frames with low latency to ensure safety. In this project, we propose a common feature extractor for multiple components of system, which significantly reduces the computations performed.
